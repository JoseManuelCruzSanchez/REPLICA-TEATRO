...
if(window.location.pathname.indexOf('/programacion/') !== -1){
    ...
    function inserta_eventos_destacados_en_DOM(array_eventos) {
        document.getElementById('img-evento-destacado-1').src = array_eventos[0].imagen_del_evento;
        document.getElementById('h2-evento-destacado-1').innerHTML = array_eventos[0].titulo_del_evento;
        document.getElementById('h3-evento-destacado-1').innerHTML = array_eventos[0].fecha_del_evento + ' / ' + eventos.destacados[0].hora_del_evento;
        document.getElementById('enlace-evento-destacado-1').href = array_eventos[0].get_permalink;

        document.getElementById('img-evento-destacado-2').src = array_eventos[1].imagen_del_evento;
        document.getElementById('h2-evento-destacado-2').innerHTML = array_eventos[1].titulo_del_evento;
        document.getElementById('h3-evento-destacado-2').innerHTML = array_eventos[1].fecha_del_evento + ' / ' + eventos.destacados[0].hora_del_evento;
        document.getElementById('enlace-evento-destacado-2').href = array_eventos[1].get_permalink;
    }
